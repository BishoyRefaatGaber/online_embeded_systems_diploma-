...
#define PORT_INPUT_PINS   0x87
#define PORT_OUTPUT_PINS  0xFF
#define MOST_BIT_PIN  1
#define LEAST_BIT_PIN 3
#define RS  1
#define EN  2


//MICROCONTROLLER CONFIGURATIONS
#define LCD_DATA_CTRL              PORTA
#define LCD_DATA_CTRL_DIR          DDRA
#define CONFIG_DATA_CTRL(x)   LCD_DATA_CTRL_DIR = (( LCD_DATA_CTRL_DIR & PORT_INPUT_PINS) | PORT_##x##_PINS);
		/**************************************/

//LCD CONTROL
#define LCD_ENABLE                   LCD_DATA_CTRL  |=(1<<EN); _delay_ms(50); LCD_DATA_CTRL &= ~(1<<EN);								
#define LCD_WRITE_DATA                     (1<<RS)
#define LCD_WRITE_INSTRUCTION             ~(1<<RS)
