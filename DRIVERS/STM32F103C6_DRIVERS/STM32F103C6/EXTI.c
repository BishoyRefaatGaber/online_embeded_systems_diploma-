...
//Used to choose the port according to specs
//0000: PA[x] pin
//0001: PB[x] pin
//0010: PC[x] pin
//0011: PD[x] pin
...
void Update_EXTI(EXTI_CONFIG_t * EXTI_CONFIG){
	...
	GPIO_PinConfig_t EXTI_PinCFG;
	EXTI_PinCFG.GPIO_PinNumber = EXTI_CONFIG->EXTI_PIN.GPIO_PIN;
	EXTI_PinCFG.GPIO_MODE = GPIO_MODE_ALTERNATIVE_INPUT;
	EXTI_PinCFG.GPIO_FREQ_SPEED = GPIO_FREQ_IN;
	MCAL_GPIO_INIT_PIN(EXTI_CONFIG->EXTI_PIN.GPIO_PORT , &EXTI_PinCFG);
