...
void MCAL_I2C_Reset(I2C_t *I2Cx ){
	if(I2Cx == I2C1){
...
void MCAL_I2C_GPIO_SetPins(I2C_t *I2Cx ){
	GPIO_PinConfig_t gpiocfg;
	if(I2Cx == I2C1){
		//PB6 I2C1_SCL
		//PB7 I2C1_SDA
		gpiocfg.GPIO_PinNumber = GPIO_PIN_6;
		gpiocfg.GPIO_MODE = GPIO_MODE_OUTPUT_ALTERNATE_OPENDRAIN;
		gpiocfg.GPIO_FREQ_SPEED = GPIO_FREQ_10MHZ;
		MCAL_GPIO_INIT_PIN(GPIOB, &gpiocfg);
...
void I2C_GenerateSTART(I2C_t *I2Cx , FunctionalState new_state ,  Reapeted_Start start){
...
void I2C_GenerateStop(I2C_t *I2Cx,  FunctionalState new_state){
	if(new_state == Enable){
...
void MCAL_I2C_Master_Tx(I2C_t *I2Cx , uint16_t devAddr , uint8_t *dataOut , uint32_t datalen , Stop_Condition stop , Reapeted_Start start){
...
void MCAL_I2C_Master_Rx(I2C_t *I2Cx , uint16_t devAddr , uint8_t *dataOut , uint32_t datalen , Stop_Condition stop , Reapeted_Start start){
...
void MCAL_I2C__SlaveSendData(I2C_t * I2Cx , uint8_t data){
...
void MCAL_I2C__SlaveReceiveData(I2C_t * I2Cx ){
