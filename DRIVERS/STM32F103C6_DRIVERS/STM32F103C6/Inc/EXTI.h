...
typedef struct{
	EXTI_GPIO_MAPPING_t EXTI_PIN;      //Specifies the external interrupt pins with GPIO to be configured .
	                                   //This parameter must be a value of @EXTI_GPIO define



	uint8_t EXTI_CASE;        	//Specifies when you want to raise the interrupt .
									//This parameter must be a value of @EXTI CASE define



	uint8_t IRQ_EN;   				//Specifies enable or disable the interrupt.
									//This parameter must be a value of @IRQ enable
...
#define EXTI_CASE_RISING   1
#define EXTI_CASE_FALLING  2
#define EXTI_CASE_RISING_FALLING  3
...
/**================================================================
* @Fn - MCAL_GPIO_UPDATE
* @brief - Update the external interrupt
* @param[in] - Pin configurations
*/
