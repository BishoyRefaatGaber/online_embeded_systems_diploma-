...
#define GPIO_PortG		0x40012000UL
#define GPIO_PortF		0x40011C00UL
#define GPIO_PortE		0x40011800UL
#define GPIO_PortD		0x40011400UL
#define GPIO_PortC		0x40011000UL
#define GPIO_PortB		0x40010C00UL
#define GPIO_PortA		0x40010800UL
...
#define Power_control_PWR 				0x40007000UL
#define Backup_registers_BKP 			0x40006C00UL
#define bxCAN1 							0x40006400UL
#define bxCAN2 							0x40006800UL
#define Shared_USB_CAN_SRAM_512_bytes 	0x40006000UL
#define USB_device_FS_registers 		0x40005C00UL
...
#define Independent_watchdog_IWDG 	0x40003000UL
#define Window_watchdog_WWDG  		0x40002C00UL
#define RTC							0x40002800UL
#define TIM14_timer					0x40002000UL
#define TIM13_timer					0x40001C00UL
#define TIM12_timer					0x40001800UL
#define TIM7_timer					0x40001400UL
#define TIM6_timer					0x40001000UL
#define TIM5_timer 					0x40000C00UL
#define TIM4_timer 					0x40000800UL
#define TIM3_timer 					0x40000400UL
#define TIM2_timer 					0x40000000UL
...
#define I2C_OAR1_ADD0_Msk			(1 << I2C_OAR1_ADD0_Pos)
#define I2C_OAR1_ADD0				I2C_OAR1_ADD0_Msk

#define I2C_OAR1_ADD1_Pos			(1U)
#define I2C_OAR1_ADD1_Msk			(0X7FUL << I2C_OAR1_ADD1_Pos)
#define I2C_OAR1_ADD1				I2C_OAR1_ADD1_Msk

#define I2C_OAR1_ADD8_Pos			(8U)
#define I2C_OAR1_ADD8_Msk			(0X3UL << I2C_OAR1_ADD8_Pos)
...
#define RCC_USART2_RESET()   (RCC->APB2RSTR |= 1 << 17)
#define RCC_USART3_RESET()   (RCC->APB2RSTR |= 1 << 18)
...
#define NVIC_IRQ33_I2C2_EV_ENABLE			(NVIC_ISER1 |= 1 << 1)	//32-33
#define NVIC_IRQ34_I2C2_ER_ENABLE			(NVIC_ISER1 |= 1 << 2)	//32-34
...
#define NVIC_IRQ33_I2C2_EV_DISABLE			(NVIC_ICER1 |= 1 << 1)	//32-33
#define NVIC_IRQ34_I2C2_ER_DISABLE			(NVIC_ICER1 |= 1 << 2)	//32-34
