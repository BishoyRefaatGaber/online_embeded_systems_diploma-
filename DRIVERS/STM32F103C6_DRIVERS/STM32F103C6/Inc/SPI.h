...
typedef struct{
	...
	uint16_t MSTR;	//Specifies the SPI operation mode (Master/Slave) @ref MSTR_define
	...
	uint16_t LSBFIRST;	//Specifies (LSB/MSB) @ref LSBFIRST_define

	uint16_t DFF;	//Specifies Data size transmitted @ref DFF_define
