...
#define LCD_INPUT_PINS			//Zeros on the input pins of the LCD to be masked with the input
#define PORT_OUTPUT_PINS		//ones on the output pins of the port to be masked with the output to the LCD


#define MOST_BIT_PIN				////used to shift right the LCD input if it is in the middle of the Port  specially in 4 bit mode
#define LEAST_BIT_PIN				//used to shift left the LCD input if it is in the middle of the Port specially in 4 bit mode

#define RS 		//The register select pin
#define EN 		//enable pin
#define WR 		//read write pin
#define BF_PIN 	//busy flag pin

//MICROCONTROLLER CONFIGURATIONS
#define LCD_DATA   		//Output data register of GPIO to LCD           
#define LCD_CTRL         //Output control register of LCD  (RS , WR , EN) pins    
...
//LCD CONTROL
#define LCD_ENABLE                   LCD_CTRL |=(1<<EN); _delay_ms(50); LCD_CTRL&= ~(1<<EN); _delay_us(200);	//Enable of the LCD					
